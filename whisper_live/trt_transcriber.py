...
class WhisperTRTLLM(object):
    ...
    def process_batch(
            self,
            mel,
            text_prefix="<|startoftranscript|><|ne|><|transcribe|><|notimestamps|>",
            num_beams=1):
...
if __name__=="__main__":
    ...
    model = WhisperTRTLLM("/home/oem/wiseyak/suraj/WhisperFusion/docker/scratch-space/models/tensorrt_whisper_nepali", False, "../assets", device="cuda")
    mel, total_duration = model.log_mel_spectrogram(
        "/home/oem/wiseyak/suraj/WhisperFusion/assets/0-prachanda.wav",
    )
